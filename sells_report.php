...
$sql = "SELECT sale_date, product_name, quantity, price_per_unit, total_price, sold_by FROM sales ORDER BY sale_date DESC";
...
$pdf->Output('DokanE_Sales_Report.pdf', 'D');
?>